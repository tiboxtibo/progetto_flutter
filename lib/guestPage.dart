...
class guestPage extends StatefulWidget {
  ...
  @override
  guestPageState createState() => guestPageState(this.username_utente);
}

class guestPageState extends State<guestPage> {
  String username_utente;
  guestPageState(this.username_utente);
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(duration: const Duration(seconds: 1),content: Text('Accesso effettuato come Guest -> Non è possibile prenotare')));
                          },
